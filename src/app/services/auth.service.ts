...
export class AuthService {
    ...
    registerUser(user) {
        ...
        // return this.http.post('http://localhost:3600/users/register', user, { headers: header }).map(res => res.json());
        return this.http.post('users/register', user, { headers: header }).map(res => res.json());
    }

    authenticateMobile(mobile: string) {
        // return this.http.get('http://localhost:3600/users/find-mobile/'+ mobile).map(res=>res.json());
    ...
    authenticateEmail(email: string) {
        // return this.http.get('http://localhost:3600/users/find-email/' + email).map(res => res.json());
    ...
    authenticateUser(user) {
        ...
        // return this.http.post('http://localhost:3600/users/authenticate', user, { headers: header }).map(res => res.json());
    ...
    saveAddress(address){
        ...
        // return this.http.post('http://localhost:3600/users/save-address', address, { headers: header }).map(res => res.json());
    ...
    deleteAddress(address){
        ...
        // return this.http.post('http://localhost:3600/users/delete-address', address, { headers: header }).map(res => res.json());
        return this.http.post('users/delete-address', address, { headers: header }).map(res => res.json());
    }

    getUserAddressses(user_id){
        // return this.http.get('http://localhost:3600/users/get-address/' + user_id).map(res => res.json());
    ...
    postOrder(order) {
        let header = new Headers();
        header.append('Content-Type', 'application/json');
        // return this.http.post('http://localhost:3600/users/post-order', order, { headers: header }).map(res => res.json());
        return this.http.post('users/post-order', order, { headers: header }).map(res => res.json());
    }

    getUserRewards(user_id){
        // return this.http.get('http://localhost:3600/users/get-user-rewards/' + user_id).map(res => res.json());
