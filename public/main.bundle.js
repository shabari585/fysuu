...
var AppComponent = (function () {
            ...
            if (this.validate.validateEmail(input)) {
                ...
                this.authService.authenticateMobile(input).subscribe(function (data) {
                    if (data.success) {
                        ...
                        // Open forgot pwd db
                        $('#fp-fixed-dark-cover').css({ 'display': 'flex' });
                        _this.authService.sendOtp(input).subscribe(function (res) {
                            console.log(res);
                        });
                        _this.resendotptrig('fp');
                    }
    ...
    AppComponent.prototype.resendotptrig = function (mode) {
        switch (mode) {
            case 'signup':
                var n_1 = 10;
                $('#sign-resend-otp-text').html('You can resend otp in ' + n_1 + ' seconds.').show();
                var resendotpInterval_1 = setInterval(function () {
                    if (n_1 !== 1) {
                        n_1--;
                        $('#sign-resend-otp-text').html('You can resend otp in ' + n_1 + ' seconds.');
                    }
                    else {
                        // Show resend otp
                        $('#sign-resend-otp-text').hide();
                        $('#sign-resend').show();
                        clearInterval(resendotpInterval_1);
                    }
                }, 1000);
                break;
            case 'fp':
                n_1 = 10;
                $('#fp-resend-otp-text').html('You can resend otp in ' + n_1 + ' seconds.').show();
                var fpresendotpInterval_1 = setInterval(function () {
                    if (n_1 !== 1) {
                        n_1--;
                        $('#fp-resend-otp-text').html('You can resend otp in ' + n_1 + ' seconds.');
                    }
                    else {
                        // Show resend otp
                        $('#fp-resend-otp-text').hide();
                        $('#fp-resend').show();
                        clearInterval(fpresendotpInterval_1);
                    }
                }, 1000);
                break;
            default:
...
var MenuComponent = (function () {
    ...
    function MenuComponent(router, title, appComponent, authService, getMenuItems, datePipe) {
        ...
        this.letter_price = 0;
        // Combo
        this.day_one_combo_items = [];
        this.day_two_combo_items = [];
        this.day_three_combo_items = [];
        this.day_four_combo_items = [];
        this.day_five_combo_items = [];
        // Dry curry
                            ...
                            _this.getMenuItems.getItemDetails(el).subscribe(function (idets) {
                                if (idets.success) {
                                    ...
                                    switch (idets.msg[0].sub_name) {
                                        // Combo
                                        case 'Combo' || 'combo':
                                            _this.day_one_combo_items.push(idets.msg[0]);
                                            break;
                                        // Dry curry
                            ...
                            _this.getMenuItems.getItemDetails(el).subscribe(function (idets) {
                                if (idets.success) {
                                    ...
                                    switch (idets.msg[0].sub_name) {
                                        // Combo
                                        case 'Combo' || 'combo':
                                            _this.day_two_combo_items.push(idets.msg[0]);
                                            break;
                                        // Dry curry
                                        case 'Dry Curry' || 'dry curry' || 'Dry curries' || 'Dry curry':
                            ...
                            _this.getMenuItems.getItemDetails(el).subscribe(function (idets) {
                                if (idets.success) {
                                    ...
                                    switch (idets.msg[0].sub_name) {
                                        // Combo
                                        case 'Combo' || 'combo':
                                            _this.day_three_combo_items.push(idets.msg[0]);
                                            break;
                                        // Dry curry
                                        case 'Dry Curry' || 'dry curry' || 'Dry curries' || 'Dry curry':
                            ...
                            _this.getMenuItems.getItemDetails(el).subscribe(function (idets) {
                                if (idets.success) {
                                    ...
                                    switch (idets.msg[0].sub_name) {
                                        // Combo
                                        case 'Combo' || 'combo':
                                            _this.day_four_combo_items.push(idets.msg[0]);
                                            break;
                                        // Dry curry
                                        case 'Dry Curry' || 'dry curry' || 'Dry curries' || 'Dry curry':
                            ...
                            _this.getMenuItems.getItemDetails(el).subscribe(function (idets) {
                                if (idets.success) {
                                    ...
                                    switch (idets.msg[0].sub_name) {
                                        // Combo
                                        case 'Combo' || 'combo':
                                            _this.day_five_combo_items.push(idets.msg[0]);
                                            break;
                                        // Dry curry
                                        case 'Dry Curry' || 'dry curry' || 'Dry curries' || 'Dry curry':
            ...
            case this.day_one_status:
                if (this.day_one_slot === undefined || this.day_one_slot === null) {
                    ...
                    if (this.day_one_c_books.length < 5) {
                        ...
                        $('.sch-err').html('');
                        var today = void 0, day_one = void 0, day_two = void 0, day_three = void 0, day_four = void 0, day_five = void 0, day_six = void 0;
...
var OrdersComponent = (function () {
    ...
    OrdersComponent.prototype.ngOnInit = function () {
        ...
        this.getadMenu.getUserOrders(this.userId).subscribe(function (res) {
            ...
            console.log(_this.orders[5].items);
        });
    };
